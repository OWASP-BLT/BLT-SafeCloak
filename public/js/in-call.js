/**
 * BLT-SafeCloak — in-call.js
 * Logic moved from video.js for the actual in-call page.
 * Handles peer setup, media, consent and optional auto-join when a room query
...
const VideoChat = (() => {
    ...
    async function initPeer() {
        ...
        peer.on('open', id => {
            ...
            // if the page was opened with a room query, initiate the call
